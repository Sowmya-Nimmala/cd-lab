{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyPiPE6vanbzYNE0SenImSMm",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Sowmya-Nimmala/cd-lab/blob/main/ex7.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "axpCE4vEu_WJ",
        "outputId": "80053de9-20cf-43bd-df05-a87f26dd5374"
      },
      "outputs": [
        {
          "output_type": "stream",
