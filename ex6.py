{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNBs8eY/5wBp5nr91j2LJCF",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Sowmya-Nimmala/cd-lab/blob/main/ex6.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "iF8CfPAzueC4",
        "outputId": "205240f6-d4fe-4a30-a0d9-3015fe41dfcc"
      },
      "outputs": [
        {
          "output_type": "stream",
